...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/torchmd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14875&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/torchmd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `torchmd` can be installed with:

```
conda install torchmd
```

It is possible to list all of the versions of `torchmd` available on your platform with:
